...
<footer id="footer" class="bg-[#003B1F] text-white">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">

            {{-- Tentang ── --}}
            <div class="sm:col-span-2 lg:col-span-1">
                <h3 class="font-manrope font-bold text-xl mb-4" style="font-family:'Manrope',sans-serif;">
                    Pasar Sinpasa
                </h3>
                ...
                <p class="text-green-300 text-sm">+62 895-1230-0903</p>
                <p class="text-green-300 text-sm mt-1">sinpasasummareconbdg@gmail.com</p>
            </div>

            {{-- Informasi ── --}}
            <div>
                <h4 class="font-semibold mb-4 text-sm uppercase tracking-widest text-green-300">Informasi</h4>
                <div class="space-y-2">
                    <a href="{{ route('guest.snk') }}"
                       class="block text-sm text-green-200 hover:text-white transition-colors">
                        Syarat &amp; Ketentuan
                    </a>
            ...
            {{-- Sosial ── --}}
            <div>
                <h4 class="font-semibold mb-4 text-sm uppercase tracking-widest text-green-300">Ikuti Kami</h4>
    ...
    <div class="border-t border-white/10">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 text-center text-xs text-green-400">
